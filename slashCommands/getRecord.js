...
import { getImgUrl } from "../index.js";
import { EmbedBuilder } from 'discord.js';
export const name = "getrecord";
export const data = new SlashCommandBuilder()
    .setName("getrecord")
    .setDescription("Gets the record of an NHL team.")
    .addStringOption((option) => option.setName("team").setDescription("The team to get the record of.").setRequired(true));
export async function execute(interaction) { 
    ...
    if (teamId != -1) {
        ...
        interaction.reply("Could not find team " + team);
    }       
}    